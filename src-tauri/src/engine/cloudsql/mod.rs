...
mod tests {
    ...
    /// l'autre — la marque d'une course, pas d'un test faux). La course est `ETXTBSY` ;
    /// `programme::poser_un_executable` porte le remède et sa raison, pour les trois scopes qui
    /// posent un faux exécutable.
