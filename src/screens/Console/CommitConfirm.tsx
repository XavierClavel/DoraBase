 ...
 * manque un. Le panneau derrière elle porte déjà la liste complète : la modale ne la redit pas, elle
 * en donne la mesure — « 2 DELETE, dont un sans WHERE » est ce qui fait s'apercevoir qu'on s'est
 * trompé.
 */
